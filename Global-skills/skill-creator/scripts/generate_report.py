#!/usr/bin/env python3
"""Generate an HTML report from skill description optimization results.

Takes JSON output from the description optimization loop and generates a visual HTML report
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate HTML report from description optimization output"
    )
